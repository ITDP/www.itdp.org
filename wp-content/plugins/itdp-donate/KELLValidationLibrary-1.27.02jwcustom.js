//KELL Validation
// v 1.27.02i Joe Westcott add classes to billingstateprovince dropdown
...
function MakeStateDropdown(labelName) {
    ...
    j$(p).html('<label class="grid-25 mobile-grid-100" for="BillingStateProvince" class="editable">' + labelName + '</label>');
    j$(p).append('<select class="grid-75 mobile-grid-100" name="BillingStateProvince" class="required" size="1" onChange="CheckField(this);" id="BillingStateProvince" ></select>');
}
/***
 * 
 * @returns {}
...
function MakeStateOther() {
    var p = j$('#BillingStateProvince').parent();
    j$(p).html('<label class="grid-25" for="BillingStateProvince" class="editable">State / Province:</label>');
    j$(p).append('<input class="grid-75" type="text" name="BillingStateProvince" id="BillingStateProvince" />');
}
/**
